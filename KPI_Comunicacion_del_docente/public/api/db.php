<?php
$DB_HOST = 'localhost'; $DB_USER = 'root'; $DB_PASS = ''; $DB_NAME = 'kpi_docente_db';
try {
...
} catch (PDOException $e) { http_response_code(500); echo json_encode(['error' => 'Error de conexión']); exit; }
